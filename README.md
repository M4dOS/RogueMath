...
[ТЗ для “Проект 1”](https://integralize.notion.site/1-Roguelike-8250f9cf3f20436abc5f3036350bf427)
...
- **Основные требования к проекту (уровень 1)**
    ...
    - В системе классов программы **должны быть предусмотрены следующие крупные блоки**:
        ...
        - Item_Pack (расположенные на карте, в инвентаре, оружие и т.д.).
- **Дополнительные требования к проекту (уровень 2)**
    1) **Сгенерированная случайным образом карта** (локации, комнаты, коридоры и т.д.), содержит персонажей и Item_Pack.
    ...
    3) **У персонажей есть поле зрения** (игрок видит Item_Pack, стены, врагов в определённом радиусе, запоминает расположение только стен, дверей, пола, но Item_Pack и враги исчезают из поля зрения), враги видят игрока в своём радиусе.
